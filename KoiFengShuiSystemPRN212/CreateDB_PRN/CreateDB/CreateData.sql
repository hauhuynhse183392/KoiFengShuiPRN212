...
VALUES 
(N'Hình tròn','F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\pond\hinhtron.jpg'),
(N'Hình vuông','F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\pond\Square.jpg'),
(N'Hình chữ nhật','F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\pond\hinhchunhat.jpg'),
(N'Hình lượn sóng','F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\pond\hinhluonsong.jpg'),
(N'Hình tam giác','F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\pond\triangular.jpg');
...
(N'Hariwake', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Hariwake.jpg', N'Thổ', N'Hariwake là một trong những dòng cá koi vàng được yêu thích nhất với màu sắc vàng rực rỡ bao phủ trên toàn thân. Điểm nổi bật của dòng cá koi này là chúng có các đốm vàng trên lưng và cánh tay của nó. Koi hariwake được coi là biểu tượng của sự giàu có và thịnh vượng theo văn hóa Nhật Bản.'),
(N'Kikusui', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Kikusui.png', N'Kim', N'Cá koi Kikusui về cơ bản là một phiên bản Doitsu của koi Hariwake, là một con koi kim loại, hai màu với màu cơ bản là trắng và hoa văn màu đỏ, cam hoặc vàng trên nền màu trắng . Kikusui cũng thường được mô tả là koi kim loại, Doitsu Kohaku koi vì nó là một con koi trắng, không vảy với hoa văn màu đỏ trên nền trắng và một lớp ánh sáng phản chiếu, hoặc bóng, trên da của cá koi.'),
(N'Goshiki', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Goshiki.png', N'Hỏa', N'Cá koi Goshiki là kết quả lai tạo thành công hai giống cá koi phổ biến asagi và cá koi kohaku. Có thể nói cá koi Goshiki là một con kohaku với lớp vẩy caro màu đen ấn tượng trên lưng làm nổi bật những mảng màu đỏ (hi) vốn có của giống kohaku. Từ Goshiki có nghĩa là ngũ sắc các nhà tạo giống rất yêu thích và ấn tượng với giống cá này bởi màu sắc nó khá phong phú và đẹp mắt.'),
(N'Goromo', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Goromo.png', N'Hỏa', N'Cá koi Goromo là kết quả lai tạo tình cờ giữa một con cá koi kohaku, một con Sanke hoặc một con Showa với một con cá koi Asagi. Bình thường việc lai tạo các giống koi trên với koi asagi chỉ tạo ra koi Goshiki. Chính vì đặc điểm này mà cá koi mới được đặt tên là “Goromo” – nghĩa tiếng Nhật là “được khoác áo”. Thực chất Goromo chỉ là tên rút gọn, tên đầy đủ của dòng koi Goromo này phải là Ai Goromo có nghĩa là “ được khoác áo màu xanh Indigo”.'),
(N'Soragoi', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Soragoi.png', N'Kim', N'Cá koi Soragoi (SOH-rog-GOY) là những con koi xám đơn màu thường có dạng lưới trên vảy của chúng được gọi là fukurin (FOO-koo-REEN).Do đó, hầu hết cá koi Soragoi đều có tiềm năng là cá koi rất lớn và thường hướng về thức ăn hơn các loại koi khác. Điều này rất tốt cho người nuôi cá koi vì nó có nghĩa là Soragoi và Chagoi, koi sẽ thường đến chào đón bạn ở đầu ao với hy vọng được cho ăn và bất kỳ con cá nào khác trong ao sẽ đi theo chúng!'),
(N'Hi Utsuri', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Hi_Utsuri.png', N'Hỏa', N'Koi utsuri có điểm đặc trưng là những bệt màu tạo thành vệt hoặc khoang màu lớn trên màu nền đen của chúng.Tại phần đầu của cá koi utsuri luôn có những mảng hoặc vệt màu đen. Các mảng đen trên mình koi utsuri có thể là mảng lớn, chấm nhỏ hoặc vệt uốn lượn theo chiều ngang'),
(N'Ki Utsuri', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Ki_Utsuri.png', N'Thổ', N'Koi utsuri có điểm đặc trưng là những bệt màu tạo thành vệt hoặc khoang màu lớn trên màu nền đen của chúng.Tại phần đầu của cá koi utsuri luôn có những mảng hoặc vệt màu đen. Các mảng đen trên mình koi utsuri có thể là mảng lớn, chấm nhỏ hoặc vệt uốn lượn theo chiều ngang'),
(N'Tancho Kohaku', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Tancho_Kohaku.png', N'Kim', N'Koi tancho kohaku chính là “quốc kì sống” của đất nước Nhật Bản, chúng có thân mình và phần bụng màu trắng muốt như tuyết, tất cả các vây cũng màu trắng và chỉ có duy nhất một chấm màu đỏ lớn ở trên đầu. Đây cũng là loại cá koi Tancho được nhiều người biết đến và ao ước được sở hữu nhất.'),
(N'Kujaku', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Kujaku.png', N'Kim', N'Cá Koi KujaKu là một trong những dòng cá Koi nổi bật bởi sở hữu bộ vảy ánh bạc nền đen pha lẫn các dãy màu đỏ vô cùng kiêu hãnh và bắt mắt. Trong vài năm gần đây, Kujaku đang ngày càng gây được sự chú ý lớn tại Việt Nam, trở thành giống cá được nhiều người yêu Koi tìm kiếm.'),
(N'Shiro Utsuri', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\shiro-utsuri.jpg', N'Kim', N'Cá koi utsuri được lai tạo sao cho thân mình của chúng thường chỉ có hai màu, trong đó màu đen (sumi) chiếm tỷ lệ nhỏ hơn, tạo thành các bệt đen (vết đen) trên thân cá.'),
(N'Ochiba Shigure', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\ochibaSigure.jpg', N'Kim', N'Ochiba là giống cá Koi được lai tạo như một sự kết hợp của Chagoi và Kohaku. Trong tiếng Anh, thuật ngữ Nhật Bản dịch gần như là là mùa thu trên mặt nước. Điều này thể hiện màu sắc ánh kim loại trên mình cá Ochiba.'),
(N'Ogon', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\ogon.jpg', N'Thổ', N'Cá Koi Ogon được coi là một trong những giống cá Koi đẹp nhất và độc đáo nhất trên trái đất với ngoại hình đặc trưng là màu vàng óng ánh rực rỡ.'),
(N'Shusui', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\shusui.png', N'Kim',N'Cá koi Shusui là một trong những giống cá chép đẹp và độc đáo nhất trong thế giới cá cảnh. Với thiết kế hai mảng vẩy lớn sậm màu trải dài từ vai xuống lưng, cá koi Shusui thực sự là một tác phẩm nghệ thuật sống đầy ấn tượng'),
(N'Taisho Sanke', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\TaishoSanke.jpg', N'Kim',N' Koi Taisho Sanke là một trong số 2 dòng chính được lai tạo từ cá chép hoang dã Magoi cổ xưa tại Nhật Bản.'),
(N'Kikokuryu', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Kikokuryu.jpg', N'Kim', N'Cá Kikokuryu thực chất là một Kumonryu kim loại, một con cá koi với làn da bạch kim sáng bóng và vây với màu sắc Sumi sâu trong suốt. Dòng Koi  sẽ không có 2 con nào giống nhau vì chúng rất hiếm được thấy trên thị trường.'),
(N'Kin Kikokuryu', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\KinKikokuryu.jpg', N'Thủy',N' Kin Kikokuryu kết hợp màu da cam hoặc màu vàng với các mẫu màu đen và trắng của Kikokuryu để tạo thành loại koi mới nhất trong họ cá Koi.'),
(N'Showa Sanshoku', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\showa_sanshoku.jpg', N'Kim', N'Mặc dù tất cả các Showa phải sở hữu làn da đen (gọi là Sumi) được bao phủ bởi các dấu hiệu từ đỏ đến đỏ cam (Hi) và trắng (Shiroji) trên đó, có rất nhiều giống Showa khác nhau bao gồm các loại hoa văn và cách sắp xếp khác nhau.'),
(N'Kohaku', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\kohaku.jpg', N'Hỏa', N'Kohaku – dòng cá kết hợp tương phản giữa 2 màu trắng(Shiroji) và đỏ (Hi) đã tạo nên vẻ đẹp đơn giản không chỉ phổ biến nhất, đẹp nhất mà còn luôn tiềm ẩn khả năng trở thành chủng cá có giá trị cao nhất trong các dòng cá Koi.'),
(N'Asagi', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\asagi.jpg', N'Thủy', N'Asagi chính là giống sản sinh ra Nishikigoi, chúng bắt nguồn từ loài cá chép đen thường sinh sống ở những vùng sông hoặc suối, những chú cá chép đen có sự tiến hóa vượt bậc và được người dân Nhật chọn lựa những chú cá có màu sắc như Trắng, Xanh dương và màu đỏ và giữ lại trong hồ.'),
(N'Kumonryu', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\kumonryu.png', N'Kim', N'Kumonryu là koi Doitsu có hoa văn màu đen như mực nổi lên như những đám mây sấm đen cuồn cuộn trên nền tuyết trắng. Một con Koi Ben Kumonryu được đánh giá là đẹp khi có sự tương xứng và cân bằng giữa các màu đỏ, đen và trắng trên thân của nó.'),
(N'Beni Kumonryu', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Beni_Kumonryu.jpg', N'Hỏa', N'Koi Beni Kumonryu là một biến thể hiếm hoi của Kumonryu, chúng thường có ba màu là đỏ, đen và trắng.'),
(N'Ginrin Chagoi', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\GinrinChagoi.jpg', N'Thổ', N'Ginrin Chagoi luôn chiếm được sự yêu thích từ người chơi cá koi. Chagoi biểu tượng cho sự mạnh mẽ, dũng cảm, sẵn sàng đương đầu với thử thách để đạt được thành công.' ),
(N'Matsuba', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\matsubaKOI.png', N'Kim', N'Koi Matsuba là những con cá đơn sắc. Giống cá này thường có 3 màu chủ yếu là màu trắng bạc, màu vàng hoặc màu đỏ cam. Matsuba là cá koi màu kim loại với hoạ tiết lưới màu đen. Cơ thể của cá koi Matsuba có một màu với vảy hình nón rỗng'),
(N'Gin Rin Yamato Nishiki', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\GinRinYamatoNishiKi.jpg', N'Hỏa', N'Gin Rin Yamato nishiki koi là loài cá được lai tạo khoảng thời gian sau này của giống koi sanke. Có thể nói cá koi yamato nishiki giúp vẻ đẹp màu sắc Gin Rin tiến đến một tầm mới hơn khi phủ lên mình cá một lớp ánh kim loại lấp lánh.'),
(N'Ushutimono', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Ushutimono.jpg', N'Mộc', N'Ushutimono có màu xanh chiếm phần lớn cơ thể, với các vảy màu trắng xen kẽ. Hoa văn của vảy tạo ra sự tương phản rõ rệt giữa màu xanh và trắng, với màu xanh nổi bật hơn, bao phủ phần lớn thân cá. Các vây và đuôi cũng có màu xanh nhẹ. Cá này có thể là một biến thể của dòng Koi có sự pha trộn mạnh mẽ giữa hai màu xanh và trắng.'),
(N'Midorigoi', N'F:\FPT\Major\Semester_5\PRN212\KoiFengShuiSystemPRN212\CreateDB_PRN\KOI_FISH\Midorigoi.jpg', N'Mộc', N'Midorigoi có màu xanh lục nhạt phủ toàn thân, với các vảy đều đặn và bóng loáng. Màu sắc chủ đạo là xanh lục, bao gồm cả vây và đuôi. Cá này có thể thuộc dòng Koi Ogon, đặc trưng bởi màu đơn sắc và sự bóng bẩy của lớp vảy.');
